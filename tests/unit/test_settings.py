...
def test_harness_runtime_mode_exposes_tool_enabled_manifest() -> None:
    ...
    assert dict(app.state.agent_manifest.tool_versions) == {
        ...
        "set_coaching_profile": "v7",
        "set_body_profile": "v7",
        "set_exercise_profile": "v7",
        "upsert_food_preference": "v7",
        "upsert_exercise_preference": "v7",
        "set_weight_goal": "v7",
        "set_body_fat_goal": "v7",
        "set_behavior_goal": "v7",
        "record_user_constraint": "v7",
        "list_user_memories": "v7",
        "forget_user_memory": "v7",
        "set_conversation_handoff": "v7",
        "resolve_conversation_handoff": "v7",
        "clear_user_memories": "v7",
