...
def test_harness_runtime_mode_exposes_tool_enabled_manifest() -> None:
    ...
    assert dict(app.state.agent_manifest.tool_versions) == {
        ...
        "set_coaching_profile": "v5",
        "set_body_profile": "v5",
        "upsert_food_preference": "v5",
        "upsert_exercise_preference": "v5",
        "set_weight_goal": "v5",
        "set_behavior_goal": "v5",
        "record_user_constraint": "v5",
        "list_user_memories": "v5",
        "forget_user_memory": "v5",
        "set_conversation_handoff": "v5",
        "resolve_conversation_handoff": "v5",
        "clear_user_memories": "v5",
