...
MIGRATIONS = (
    ...
    SchemaMigration("20260905_01_style_profiles", _create_application_tables),
    SchemaMigration("20260906_01_nutrition_knowledge", _create_application_tables),
    SchemaMigration("20260908_01_style_ab_reviews", _create_application_tables),
    SchemaMigration("20260908_02_style_ab_scenarios", _create_application_tables),
    SchemaMigration(
