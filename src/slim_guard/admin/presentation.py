...
AGENT_ROLE_LABELS = {
    ...
    "user_dish_confirmation": "用户菜名确认",
    "admin_reviewer": "管理员人工评审",
...
ARTIFACT_TYPE_LABELS = {
    ...
    "dish_recognition": "菜品识别结果",
    "dish_recognition_correction": "菜品识别人工更正",
    "confirmed_dish_set": "已确认菜品",
    "dish_evidence_bundle": "菜品营养证据",
    "diet_guidance_assessment": "逐菜饮食判断",
    "citation": "资料引用",
...
WORKFLOW_NODE_LABELS = {
    ...
    "dish_confirmation_pending": "等待用户确认菜名",
    "dish_confirmation_resolved": "用户已确认菜名",
    "nutrition_retrieval_running": "检索菜品与营养证据",
    "nutrition_evidence_ready": "菜品营养证据就绪",
